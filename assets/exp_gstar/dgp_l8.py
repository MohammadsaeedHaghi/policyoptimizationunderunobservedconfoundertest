...
_sp = importlib.util.spec_from_file_location("gstar_core_l8", Path(__file__).resolve().parent / "dgp.py")
_m = importlib.util.module_from_spec(_sp); sys.modules["gstar_core_l8"] = _m; _sp.loader.exec_module(_m)
_m.LAM = 8.0
