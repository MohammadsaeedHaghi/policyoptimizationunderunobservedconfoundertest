"""Run all XX and OX methods on the 'first prime' DGP (N=10000 study, XX+OX only) (piecewise-linear first experiment), N_train=10000, one seed,
...
(HERE / "prime_n10000_results.json").write_text(json.dumps(out, indent=2))
