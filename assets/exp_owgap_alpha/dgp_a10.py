"""exp_owgap_alpha: the exp_owgap DGP with the S|X coupling strength ALPHA = 10.0.

Same DGP as assets/exp_owgap/dgp.py in every respect EXCEPT P(S=+1|X) = sigma(ALPHA*X) with
ALPHA = 10.0 (base owgap: 10.0). The sweep ALPHA in {1,2,4,6,10} varies how predictable the
...
_spec = importlib.util.spec_from_file_location("owgap_base_a10", str(_BASE))
