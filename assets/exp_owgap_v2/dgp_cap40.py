"""exp_owgap_v2 cap-robustness variant: identical DGP, treatment budget cap = 40% (base v2: 30%).
...
_spec = importlib.util.spec_from_file_location("owgap_v2_base_c40", str(_BASE))
