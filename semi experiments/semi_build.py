...
<tr><td>Kallus &amp; Zhou (NeurIPS'18; Mgmt Sci'21) &mdash; OUR DIRECT BASELINE
<br><span class="muted">(CORRECTED 2026-07-27: earlier draft wrongly said IST; verified
against the papers' full text)</span></td>
<td><b>WHI</b> (Women's Health Initiative: hormone-replacement trial + parallel observational
study)</td>
<td>real observational cohort evaluated against its matching RCT</td>
<td class="b">restricted (BioLINCC application)</td>
<td>their construction needs a paired obs+RCT cohort; data access makes replication impractical
for us</td></tr>
<tr><td>Sharp/efficient OPE under confounding (Frauen et al. 2025, arXiv 2502.13022)</td>
<td><b>IST</b> (19,435 stroke patients; outcome time-to-death)</td>
<td>RCT + confounding injected by biased subsampling with diastolic blood pressure hidden
(recipe D)</td><td>yes (free CSV)</td>
<td class="g">direct precedent for our IST recipe-D construction (we hide consciousness and
calibrate to matched &Lambda;)</td></tr>
...
<p><b>Why this one:</b> the RCT-plus-injected-confounding construction on IST has direct
precedent in the confounded-OPE literature (Frauen et al. 2025 hide diastolic blood pressure the
same way), outcomes need NO synthesis (both arms are real RCT arms), and a capacity cap has a
natural reading (scarce anticoagulation/monitoring capacity). NOTE (corrected): Kallus &amp;
Zhou's own case study is WHI, whose restricted access makes it impractical here; IST is the
literature's accessible recipe-D dataset.</p>
