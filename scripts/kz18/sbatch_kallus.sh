...
python3 assets/exp_owgap_alpha/run_kallus.py --dgp assets/exp_kz18/dgp.py --out assets/exp_kz18/kz_kallus.json --n 200 --seeds 5 --gammas 1,2,3,4.4817,6,8 --eval draws --n-test 4000 \
