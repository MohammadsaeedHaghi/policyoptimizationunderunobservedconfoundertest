...
python3 assets/run_owgap_lip_gamma_2d.py --dgp assets/exp_kz18/dgp.py --out assets/exp_kz18/kz_main_ce2.0.json --n 400 --ceps 2.0 --gammas 1,2,3,4.4817,6,8 --seeds 5 --n-test 4000 --workers 5 --deploy shapley \
